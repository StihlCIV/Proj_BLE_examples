...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_FIND_MY_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_BC2_PROTOTYPE_REV02, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_DATA_LEN_MAX, 190);
